// @shared-module: copied from azure-pipelines-terraform (Tasks/TerraformInstaller/TerraformInstallerV1/src/registry-allowlist.ts)
// @shared-module-policy: This is a copy of the sibling extension's egress-authorization
//   module. Until a shared cross-extension package is extracted, apply fixes to both
...
//   azure-pipelines-terraform's copy as of 2026-08-08 (numeric address classification +
//   assertEgressHostAllowed); only this provenance header differs.
