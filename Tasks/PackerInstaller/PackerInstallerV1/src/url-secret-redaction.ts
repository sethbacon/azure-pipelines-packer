// @shared-module: copied from azure-pipelines-terraform (Tasks/TerraformInstaller/TerraformInstallerV1/src/url-secret-redaction.ts)
// @shared-module-policy: This is a copy of the sibling extension's URL credential-masking
//   helpers. Until a shared cross-extension package is extracted, apply fixes to both
//   copies and keep the provenance header current. Enforced by scripts/check-shared-modules.js.
// @shared-module-status: IN-SYNC — byte-identical to azure-pipelines-terraform's copy as of
//   2026-08-08 apart from this provenance header (terraform gates its four in-repo copies on
//   byte identity via its own scripts/check-shared-modules.js url-secret-redaction family).
/**
